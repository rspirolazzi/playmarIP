<script>
    $(function () {
        // Display the create service modal
        $('#create-service').modal('show');
        ...
        // Creates the service
        $('#service_create_confirm').click(function () {
            console.log('clicked');
            // Posts the data to validate and create the service;
            // will create the new client if necessary
            $.post("<?php echo site_url('services/ajax/create'); ?>", {
                ...
                function (data) {
                    ...
                    if (response.success === 1) {
                        // The validation was successful and service was created
...
<div id="create-service" class="modal modal-lg" role="dialog" aria-labelledby="modal_create_service" aria-hidden="true">
    <form class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><i class="fa fa-close"></i></button>
            <h4 class="panel-title"><?php _trans('create_service'); ?></h4>
        </div>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                <button class="btn btn-success ajax-loader" id="service_create_confirm" type="button">
